...
public class Segment extends SegmentGroup implements ContainerNode {
    ...
    public void setSegcodename(String value) {
        this.segcodename = value;
    }
    ...
    public boolean matches(StringBuffer sb) {
	System.out.println("Segment: segcode: "+getSegcode()+" matches: "+sb);
        Matcher matcher = getSegcodePattern().matcher(sb);
