...
public class X12835Factory {

    private Smooks smooks;
    private Delimiters delimiters;

    public static X12835Factory getInstance() throws IOException, SAXException {
        return new X12835Factory();
    }
    ...
    public X12835 fromEDI(InputStream ediStream, Result... additionalResults) {
        return fromEDI(new InputStreamReader(ediStream), additionalResults);
    }

    public X12835 fromEDI(Reader ediStream, Result... additionalResults) {
        ...
        return (X12835) javaResult.getBean(X12835.class);
    }


    public void toEDI(X12835 instance, Writer writer) throws IOException {
        instance.write(writer, delimiters);
    }

    private X12835Factory() throws IOException, SAXException {
        smooks = new Smooks(X12835Factory.class.getResourceAsStream("bindingconfig.xml"));

        try {
            Edimap edimap = EDIConfigDigester.digestConfig(X12835Factory.class.getResourceAsStream("edimappingconfig.xml"));
