...
public class PayerCityStateZipCode implements Serializable, EDIWritable {
    ...
    public PayerCityStateZipCode setCity(String city) {
    ...
    public PayerCityStateZipCode setState(String state) {
    ...
    public PayerCityStateZipCode setPostalCode(String postalCode) {
    ...
    public PayerCityStateZipCode setCountryCode(String countryCode) {
