...
public class PayerTechnicalContactInformation implements Serializable, EDIWritable {
    ...
    public PayerTechnicalContactInformation setContactFunctionCode(String contactFunctionCode) {
    ...
    public PayerTechnicalContactInformation setName(String name) {
    ...
    public PayerTechnicalContactInformation setCommunicationNumberQualifier(String communicationNumberQualifier) {
    ...
    public PayerTechnicalContactInformation setCommunicationNumber(String communicationNumber) {
    ...
    public PayerTechnicalContactInformation setCommunicationNumberQualifier2(String communicationNumberQualifier2) {
    ...
    public PayerTechnicalContactInformation setCommunicationNumber2(String communicationNumber2) {
    ...
    public PayerTechnicalContactInformation setCommunicationNumberQualifier3(String communicationNumberQualifier3) {
    ...
    public PayerTechnicalContactInformation setCommunicationNumber3(String communicationNumber3) {
