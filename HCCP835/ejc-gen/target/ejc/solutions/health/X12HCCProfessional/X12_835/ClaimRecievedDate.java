...
public class ClaimRecievedDate implements Serializable, EDIWritable {
    ...
    public ClaimRecievedDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public ClaimRecievedDate setDate(Date date) {
