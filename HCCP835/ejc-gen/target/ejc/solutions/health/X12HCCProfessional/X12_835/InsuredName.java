...
public class InsuredName implements Serializable, EDIWritable {
    ...
    public InsuredName setEntityIDCode(String entityIDCode) {
    ...
    public InsuredName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public InsuredName setLastName(String lastName) {
    ...
    public InsuredName setFirstName(String firstName) {
    ...
    public InsuredName setMiddleName(String middleName) {
    ...
    public InsuredName setNamePrefix(String namePrefix) {
    ...
    public InsuredName setNameSuffix(String nameSuffix) {
    ...
    public InsuredName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public InsuredName setIdCode(String idCode) {
    ...
    public InsuredName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public InsuredName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public InsuredName setOrganizationName(String organizationName) {
