...
public class ServiceSuppAmount implements Serializable, EDIWritable {
    ...
    public ServiceSuppAmount setAmountQualifierCode(String amountQualifierCode) {
    ...
    public ServiceSuppAmount setMonetaryAmount(String monetaryAmount) {
