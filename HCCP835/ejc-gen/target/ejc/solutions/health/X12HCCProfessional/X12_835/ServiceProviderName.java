...
public class ServiceProviderName implements Serializable, EDIWritable {
    ...
    public ServiceProviderName setEntityIDCode(String entityIDCode) {
    ...
    public ServiceProviderName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public ServiceProviderName setLastName(String lastName) {
    ...
    public ServiceProviderName setFirstName(String firstName) {
    ...
    public ServiceProviderName setMiddleName(String middleName) {
    ...
    public ServiceProviderName setNamePrefix(String namePrefix) {
    ...
    public ServiceProviderName setNameSuffix(String nameSuffix) {
    ...
    public ServiceProviderName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public ServiceProviderName setIdCode(String idCode) {
    ...
    public ServiceProviderName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public ServiceProviderName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public ServiceProviderName setOrganizationName(String organizationName) {
