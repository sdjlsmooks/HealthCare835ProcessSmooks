...
public class CrossoverCarrierName implements Serializable, EDIWritable {
    ...
    public CrossoverCarrierName setEntityIDCode(String entityIDCode) {
    ...
    public CrossoverCarrierName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public CrossoverCarrierName setLastName(String lastName) {
    ...
    public CrossoverCarrierName setFirstName(String firstName) {
    ...
    public CrossoverCarrierName setMiddleName(String middleName) {
    ...
    public CrossoverCarrierName setNamePrefix(String namePrefix) {
    ...
    public CrossoverCarrierName setNameSuffix(String nameSuffix) {
    ...
    public CrossoverCarrierName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public CrossoverCarrierName setIdCode(String idCode) {
    ...
    public CrossoverCarrierName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public CrossoverCarrierName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public CrossoverCarrierName setOrganizationName(String organizationName) {
