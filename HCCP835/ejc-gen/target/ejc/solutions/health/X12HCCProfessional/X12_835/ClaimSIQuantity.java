...
public class ClaimSIQuantity implements Serializable, EDIWritable {
    ...
    public ClaimSIQuantity setQuantityQualifier(String quantityQualifier) {
    ...
    public ClaimSIQuantity setQuantity(Integer quantity) {
