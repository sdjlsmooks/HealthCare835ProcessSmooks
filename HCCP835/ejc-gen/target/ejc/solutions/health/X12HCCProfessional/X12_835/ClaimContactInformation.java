...
public class ClaimContactInformation implements Serializable, EDIWritable {
    ...
    public ClaimContactInformation setContactFunctionCode(String contactFunctionCode) {
    ...
    public ClaimContactInformation setName(String name) {
    ...
    public ClaimContactInformation setCommunicationNumberQualifier(String communicationNumberQualifier) {
    ...
    public ClaimContactInformation setCommunicationNumber(String communicationNumber) {
    ...
    public ClaimContactInformation setCommunicationNumberQualifier2(String communicationNumberQualifier2) {
    ...
    public ClaimContactInformation setCommunicationNumber2(String communicationNumber2) {
    ...
    public ClaimContactInformation setCommunicationNumberQualifier3(String communicationNumberQualifier3) {
    ...
    public ClaimContactInformation setCommunicationNumber3(String communicationNumber3) {
