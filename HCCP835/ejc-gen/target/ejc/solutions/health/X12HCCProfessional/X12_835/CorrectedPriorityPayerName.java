...
public class CorrectedPriorityPayerName implements Serializable, EDIWritable {
    ...
    public CorrectedPriorityPayerName setEntityIDCode(String entityIDCode) {
    ...
    public CorrectedPriorityPayerName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public CorrectedPriorityPayerName setLastName(String lastName) {
    ...
    public CorrectedPriorityPayerName setFirstName(String firstName) {
    ...
    public CorrectedPriorityPayerName setMiddleName(String middleName) {
    ...
    public CorrectedPriorityPayerName setNamePrefix(String namePrefix) {
    ...
    public CorrectedPriorityPayerName setNameSuffix(String nameSuffix) {
    ...
    public CorrectedPriorityPayerName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public CorrectedPriorityPayerName setIdCode(String idCode) {
    ...
    public CorrectedPriorityPayerName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public CorrectedPriorityPayerName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public CorrectedPriorityPayerName setOrganizationName(String organizationName) {
