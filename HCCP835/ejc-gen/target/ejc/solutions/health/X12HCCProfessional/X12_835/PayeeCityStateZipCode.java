...
public class PayeeCityStateZipCode implements Serializable, EDIWritable {
    ...
    public PayeeCityStateZipCode setCity(String city) {
    ...
    public PayeeCityStateZipCode setState(String state) {
    ...
    public PayeeCityStateZipCode setPostalCode(String postalCode) {
    ...
    public PayeeCityStateZipCode setCountryCode(String countryCode) {
