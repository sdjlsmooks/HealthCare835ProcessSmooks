...
public class CorrectedPatientName implements Serializable, EDIWritable {
    ...
    public CorrectedPatientName setEntityIDCode(String entityIDCode) {
    ...
    public CorrectedPatientName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public CorrectedPatientName setLastName(String lastName) {
    ...
    public CorrectedPatientName setFirstName(String firstName) {
    ...
    public CorrectedPatientName setMiddleName(String middleName) {
    ...
    public CorrectedPatientName setNamePrefix(String namePrefix) {
    ...
    public CorrectedPatientName setNameSuffix(String nameSuffix) {
    ...
    public CorrectedPatientName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public CorrectedPatientName setIdCode(String idCode) {
    ...
    public CorrectedPatientName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public CorrectedPatientName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public CorrectedPatientName setOrganizationName(String organizationName) {
