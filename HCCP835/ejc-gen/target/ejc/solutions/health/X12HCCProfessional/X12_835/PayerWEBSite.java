...
public class PayerWEBSite implements Serializable, EDIWritable {
    ...
    public PayerWEBSite setContactFunctionCode(String contactFunctionCode) {
    ...
    public PayerWEBSite setName(String name) {
    ...
    public PayerWEBSite setCommunicationNumberQualifier(String communicationNumberQualifier) {
    ...
    public PayerWEBSite setCommunicationNumber(String communicationNumber) {
    ...
    public PayerWEBSite setCommunicationNumberQualifier2(String communicationNumberQualifier2) {
    ...
    public PayerWEBSite setCommunicationNumber2(String communicationNumber2) {
    ...
    public PayerWEBSite setCommunicationNumberQualifier3(String communicationNumberQualifier3) {
    ...
    public PayerWEBSite setCommunicationNumber3(String communicationNumber3) {
