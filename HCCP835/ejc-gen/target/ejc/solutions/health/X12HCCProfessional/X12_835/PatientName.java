...
public class PatientName implements Serializable, EDIWritable {
    ...
    public PatientName setEntityIDCode(String entityIDCode) {
    ...
    public PatientName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public PatientName setLastName(String lastName) {
    ...
    public PatientName setFirstName(String firstName) {
    ...
    public PatientName setMiddleName(String middleName) {
    ...
    public PatientName setNamePrefix(String namePrefix) {
    ...
    public PatientName setNameSuffix(String nameSuffix) {
    ...
    public PatientName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public PatientName setIdCode(String idCode) {
    ...
    public PatientName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public PatientName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public PatientName setOrganizationName(String organizationName) {
