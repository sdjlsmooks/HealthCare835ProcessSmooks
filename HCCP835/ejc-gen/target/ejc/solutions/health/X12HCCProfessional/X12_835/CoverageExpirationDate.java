...
public class CoverageExpirationDate implements Serializable, EDIWritable {
    ...
    public CoverageExpirationDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public CoverageExpirationDate setDate(Date date) {
