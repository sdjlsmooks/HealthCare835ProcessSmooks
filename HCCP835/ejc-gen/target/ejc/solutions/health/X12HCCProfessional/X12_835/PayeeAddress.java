...
public class PayeeAddress implements Serializable, EDIWritable {
    ...
    public PayeeAddress setAddressInformation(String addressInformation) {
    ...
    public PayeeAddress setAdditionalAddressInformation(String additionalAddressInformation) {
