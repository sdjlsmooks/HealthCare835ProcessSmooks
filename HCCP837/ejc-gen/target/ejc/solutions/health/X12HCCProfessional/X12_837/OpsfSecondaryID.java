...
public class OpsfSecondaryID implements Serializable, EDIWritable {
    ...
    public OpsfSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpsfSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public OpsfSecondaryID setDescription(String description) {
    ...
    public OpsfSecondaryID setReferenceIdentifier(String referenceIdentifier) {
