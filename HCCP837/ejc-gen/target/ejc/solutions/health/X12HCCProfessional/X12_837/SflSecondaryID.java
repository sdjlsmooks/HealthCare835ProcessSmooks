...
public class SflSecondaryID implements Serializable, EDIWritable {
    ...
    public SflSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public SflSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public SflSecondaryID setDescription(String description) {
    ...
    public SflSecondaryID setReferenceIdentifier(String referenceIdentifier) {
