...
public class OpRenderingProvider implements Serializable, EDIWritable {
    ...
    public OpRenderingProvider setEntityIDCode(String entityIDCode) {
    ...
    public OpRenderingProvider setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public OpRenderingProvider setLastName(String lastName) {
    ...
    public OpRenderingProvider setFirstName(String firstName) {
    ...
    public OpRenderingProvider setMiddleName(String middleName) {
    ...
    public OpRenderingProvider setNamePrefix(String namePrefix) {
    ...
    public OpRenderingProvider setNameSuffix(String nameSuffix) {
    ...
    public OpRenderingProvider setIdCodeQualifier(String idCodeQualifier) {
    ...
    public OpRenderingProvider setIdCode(String idCode) {
    ...
    public OpRenderingProvider setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public OpRenderingProvider setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public OpRenderingProvider setOrganizationName(String organizationName) {
