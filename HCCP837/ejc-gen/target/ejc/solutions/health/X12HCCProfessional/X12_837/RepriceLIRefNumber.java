...
public class RepriceLIRefNumber implements Serializable, EDIWritable {
    ...
    public RepriceLIRefNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public RepriceLIRefNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public RepriceLIRefNumber setDescription(String description) {
    ...
    public RepriceLIRefNumber setReferenceIdentifier(String referenceIdentifier) {
