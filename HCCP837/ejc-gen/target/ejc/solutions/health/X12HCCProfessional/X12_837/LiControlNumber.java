...
public class LiControlNumber implements Serializable, EDIWritable {
    ...
    public LiControlNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public LiControlNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public LiControlNumber setDescription(String description) {
    ...
    public LiControlNumber setReferenceIdentifier(String referenceIdentifier) {
