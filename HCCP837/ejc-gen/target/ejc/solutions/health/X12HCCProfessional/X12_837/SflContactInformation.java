...
public class SflContactInformation implements Serializable, EDIWritable {
    ...
    public SflContactInformation setContactFunctionCode(String contactFunctionCode) {
    ...
    public SflContactInformation setName(String name) {
    ...
    public SflContactInformation setCommunicationNumberQualifier(String communicationNumberQualifier) {
    ...
    public SflContactInformation setCommunicationNumber(String communicationNumber) {
    ...
    public SflContactInformation setCommunicationNumberQualifier2(String communicationNumberQualifier2) {
    ...
    public SflContactInformation setCommunicationNumber2(String communicationNumber2) {
    ...
    public SflContactInformation setCommunicationNumberQualifier3(String communicationNumberQualifier3) {
    ...
    public SflContactInformation setCommunicationNumber3(String communicationNumber3) {
