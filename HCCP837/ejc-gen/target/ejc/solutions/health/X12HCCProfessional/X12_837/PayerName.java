...
public class PayerName implements Serializable, EDIWritable {
    ...
    public PayerName setEntityIDCode(String entityIDCode) {
    ...
    public PayerName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public PayerName setLastName(String lastName) {
    ...
    public PayerName setFirstName(String firstName) {
    ...
    public PayerName setMiddleName(String middleName) {
    ...
    public PayerName setNamePrefix(String namePrefix) {
    ...
    public PayerName setNameSuffix(String nameSuffix) {
    ...
    public PayerName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public PayerName setIdCode(String idCode) {
    ...
    public PayerName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public PayerName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public PayerName setOrganizationName(String organizationName) {
