...
public class RemainingPatientLiability implements Serializable, EDIWritable {
    ...
    public RemainingPatientLiability setAmountQualifierCode(String amountQualifierCode) {
    ...
    public RemainingPatientLiability setMonetaryAmount(String monetaryAmount) {
    ...
    public RemainingPatientLiability setCreditDebitFlagCode(String creditDebitFlagCode) {
