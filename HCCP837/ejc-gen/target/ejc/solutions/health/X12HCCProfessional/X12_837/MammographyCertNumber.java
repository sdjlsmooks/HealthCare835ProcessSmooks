...
public class MammographyCertNumber implements Serializable, EDIWritable {
    ...
    public MammographyCertNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public MammographyCertNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public MammographyCertNumber setDescription(String description) {
    ...
    public MammographyCertNumber setReferenceIdentifier(String referenceIdentifier) {
