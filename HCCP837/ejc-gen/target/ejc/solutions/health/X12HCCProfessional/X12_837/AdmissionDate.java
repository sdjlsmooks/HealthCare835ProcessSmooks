...
public class AdmissionDate implements Serializable, EDIWritable {
    ...
    public AdmissionDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public AdmissionDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public AdmissionDate setDateTimePeriod(String dateTimePeriod) {
