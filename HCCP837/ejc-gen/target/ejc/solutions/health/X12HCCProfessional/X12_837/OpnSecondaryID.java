...
public class OpnSecondaryID implements Serializable, EDIWritable {
    ...
    public OpnSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpnSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public OpnSecondaryID setDescription(String description) {
    ...
    public OpnSecondaryID setReferenceIdentifier(String referenceIdentifier) {
