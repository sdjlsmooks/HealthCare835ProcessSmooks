...
public class MedicalRecordNumber implements Serializable, EDIWritable {
    ...
    public MedicalRecordNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public MedicalRecordNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public MedicalRecordNumber setDescription(String description) {
    ...
    public MedicalRecordNumber setReferenceIdentifier(String referenceIdentifier) {
