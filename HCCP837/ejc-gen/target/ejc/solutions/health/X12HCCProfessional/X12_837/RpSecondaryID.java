...
public class RpSecondaryID implements Serializable, EDIWritable {
    ...
    public RpSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public RpSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public RpSecondaryID setDescription(String description) {
    ...
    public RpSecondaryID setReferenceIdentifier(String referenceIdentifier) {
