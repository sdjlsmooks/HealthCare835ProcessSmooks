...
public class PtName implements Serializable, EDIWritable {
    ...
    public PtName setEntityIDCode(String entityIDCode) {
    ...
    public PtName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public PtName setLastName(String lastName) {
    ...
    public PtName setFirstName(String firstName) {
    ...
    public PtName setMiddleName(String middleName) {
    ...
    public PtName setNamePrefix(String namePrefix) {
    ...
    public PtName setNameSuffix(String nameSuffix) {
    ...
    public PtName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public PtName setIdCode(String idCode) {
    ...
    public PtName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public PtName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public PtName setOrganizationName(String organizationName) {
