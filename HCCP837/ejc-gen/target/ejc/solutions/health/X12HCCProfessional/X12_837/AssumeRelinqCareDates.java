...
public class AssumeRelinqCareDates implements Serializable, EDIWritable {
    ...
    public AssumeRelinqCareDates setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public AssumeRelinqCareDates setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public AssumeRelinqCareDates setDateTimePeriod(String dateTimePeriod) {
