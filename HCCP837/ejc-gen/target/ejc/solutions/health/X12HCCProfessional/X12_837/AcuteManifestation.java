...
public class AcuteManifestation implements Serializable, EDIWritable {
    ...
    public AcuteManifestation setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public AcuteManifestation setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public AcuteManifestation setDateTimePeriod(String dateTimePeriod) {
