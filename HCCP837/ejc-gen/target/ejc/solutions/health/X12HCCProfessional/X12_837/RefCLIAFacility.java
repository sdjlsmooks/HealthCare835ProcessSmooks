...
public class RefCLIAFacility implements Serializable, EDIWritable {
    ...
    public RefCLIAFacility setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public RefCLIAFacility setReferenceIdentification(String referenceIdentification) {
    ...
    public RefCLIAFacility setDescription(String description) {
    ...
    public RefCLIAFacility setReferenceIdentifier(String referenceIdentifier) {
