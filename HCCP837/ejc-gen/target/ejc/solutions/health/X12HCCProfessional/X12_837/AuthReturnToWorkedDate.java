...
public class AuthReturnToWorkedDate implements Serializable, EDIWritable {
    ...
    public AuthReturnToWorkedDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public AuthReturnToWorkedDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public AuthReturnToWorkedDate setDateTimePeriod(String dateTimePeriod) {
