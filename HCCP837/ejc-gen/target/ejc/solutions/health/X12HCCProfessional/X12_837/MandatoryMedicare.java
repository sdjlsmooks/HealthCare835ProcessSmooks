...
public class MandatoryMedicare implements Serializable, EDIWritable {
    ...
    public MandatoryMedicare setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public MandatoryMedicare setReferenceIdentification(String referenceIdentification) {
    ...
    public MandatoryMedicare setDescription(String description) {
    ...
    public MandatoryMedicare setReferenceIdentifier(String referenceIdentifier) {
