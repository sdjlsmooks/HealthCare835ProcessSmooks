...
public class MammogramCertNumber implements Serializable, EDIWritable {
    ...
    public MammogramCertNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public MammogramCertNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public MammogramCertNumber setDescription(String description) {
    ...
    public MammogramCertNumber setReferenceIdentifier(String referenceIdentifier) {
