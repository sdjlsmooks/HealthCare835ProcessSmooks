...
public class HearVisionPrescriptionDate implements Serializable, EDIWritable {
    ...
    public HearVisionPrescriptionDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public HearVisionPrescriptionDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public HearVisionPrescriptionDate setDateTimePeriod(String dateTimePeriod) {
