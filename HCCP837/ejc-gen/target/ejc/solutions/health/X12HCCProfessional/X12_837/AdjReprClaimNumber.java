...
public class AdjReprClaimNumber implements Serializable, EDIWritable {
    ...
    public AdjReprClaimNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public AdjReprClaimNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public AdjReprClaimNumber setDescription(String description) {
    ...
    public AdjReprClaimNumber setReferenceIdentifier(String referenceIdentifier) {
