...
public class PropCasuSubscriberContactInfo implements Serializable, EDIWritable {
    ...
    public PropCasuSubscriberContactInfo setContactFunctionCode(String contactFunctionCode) {
    ...
    public PropCasuSubscriberContactInfo setName(String name) {
    ...
    public PropCasuSubscriberContactInfo setCommunicationNumberQualifier(String communicationNumberQualifier) {
    ...
    public PropCasuSubscriberContactInfo setCommunicationNumber(String communicationNumber) {
    ...
    public PropCasuSubscriberContactInfo setCommunicationNumberQualifier2(String communicationNumberQualifier2) {
    ...
    public PropCasuSubscriberContactInfo setCommunicationNumber2(String communicationNumber2) {
    ...
    public PropCasuSubscriberContactInfo setCommunicationNumberQualifier3(String communicationNumberQualifier3) {
    ...
    public PropCasuSubscriberContactInfo setCommunicationNumber3(String communicationNumber3) {
