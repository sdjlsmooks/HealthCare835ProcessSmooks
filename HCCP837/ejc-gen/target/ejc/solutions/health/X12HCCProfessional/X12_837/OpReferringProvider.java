...
public class OpReferringProvider implements Serializable, EDIWritable {
    ...
    public OpReferringProvider setEntityIDCode(String entityIDCode) {
    ...
    public OpReferringProvider setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public OpReferringProvider setLastName(String lastName) {
    ...
    public OpReferringProvider setFirstName(String firstName) {
    ...
    public OpReferringProvider setMiddleName(String middleName) {
    ...
    public OpReferringProvider setNamePrefix(String namePrefix) {
    ...
    public OpReferringProvider setNameSuffix(String nameSuffix) {
    ...
    public OpReferringProvider setIdCodeQualifier(String idCodeQualifier) {
    ...
    public OpReferringProvider setIdCode(String idCode) {
    ...
    public OpReferringProvider setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public OpReferringProvider setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public OpReferringProvider setOrganizationName(String organizationName) {
