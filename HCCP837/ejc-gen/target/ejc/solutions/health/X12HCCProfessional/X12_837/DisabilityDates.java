...
public class DisabilityDates implements Serializable, EDIWritable {
    ...
    public DisabilityDates setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public DisabilityDates setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public DisabilityDates setDateTimePeriod(String dateTimePeriod) {
