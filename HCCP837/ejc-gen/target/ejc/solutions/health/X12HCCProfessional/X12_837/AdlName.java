...
public class AdlName implements Serializable, EDIWritable {
    ...
    public AdlName setEntityIDCode(String entityIDCode) {
    ...
    public AdlName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public AdlName setLastName(String lastName) {
    ...
    public AdlName setFirstName(String firstName) {
    ...
    public AdlName setMiddleName(String middleName) {
    ...
    public AdlName setNamePrefix(String namePrefix) {
    ...
    public AdlName setNameSuffix(String nameSuffix) {
    ...
    public AdlName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public AdlName setIdCode(String idCode) {
    ...
    public AdlName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public AdlName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public AdlName setOrganizationName(String organizationName) {
