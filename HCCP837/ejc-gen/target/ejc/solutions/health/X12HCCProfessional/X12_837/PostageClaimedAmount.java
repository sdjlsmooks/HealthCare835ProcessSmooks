...
public class PostageClaimedAmount implements Serializable, EDIWritable {
    ...
    public PostageClaimedAmount setAmountQualifierCode(String amountQualifierCode) {
    ...
    public PostageClaimedAmount setMonetaryAmount(String monetaryAmount) {
    ...
    public PostageClaimedAmount setCreditDebitFlagCode(String creditDebitFlagCode) {
