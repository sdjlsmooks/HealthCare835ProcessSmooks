...
public class OsAddress implements Serializable, EDIWritable {
    ...
    public OsAddress setAddressInformation(String addressInformation) {
    ...
    public OsAddress setAdditionalAddressInformation(String additionalAddressInformation) {
