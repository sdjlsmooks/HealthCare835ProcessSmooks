...
public class ServiceAuthExCode implements Serializable, EDIWritable {
    ...
    public ServiceAuthExCode setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public ServiceAuthExCode setReferenceIdentification(String referenceIdentification) {
    ...
    public ServiceAuthExCode setDescription(String description) {
    ...
    public ServiceAuthExCode setReferenceIdentifier(String referenceIdentifier) {
