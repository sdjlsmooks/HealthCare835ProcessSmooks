...
public class LastXRayDate implements Serializable, EDIWritable {
    ...
    public LastXRayDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public LastXRayDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public LastXRayDate setDateTimePeriod(String dateTimePeriod) {
