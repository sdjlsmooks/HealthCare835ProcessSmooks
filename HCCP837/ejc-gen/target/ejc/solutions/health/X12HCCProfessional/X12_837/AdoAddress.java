...
public class AdoAddress implements Serializable, EDIWritable {
    ...
    public AdoAddress setAddressInformation(String addressInformation) {
    ...
    public AdoAddress setAdditionalAddressInformation(String additionalAddressInformation) {
