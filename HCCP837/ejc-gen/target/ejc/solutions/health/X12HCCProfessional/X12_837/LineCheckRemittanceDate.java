...
public class LineCheckRemittanceDate implements Serializable, EDIWritable {
    ...
    public LineCheckRemittanceDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public LineCheckRemittanceDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public LineCheckRemittanceDate setDateTimePeriod(String dateTimePeriod) {
