...
public class PtpName implements Serializable, EDIWritable {
    ...
    public PtpName setEntityIDCode(String entityIDCode) {
    ...
    public PtpName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public PtpName setLastName(String lastName) {
    ...
    public PtpName setFirstName(String firstName) {
    ...
    public PtpName setMiddleName(String middleName) {
    ...
    public PtpName setNamePrefix(String namePrefix) {
    ...
    public PtpName setNameSuffix(String nameSuffix) {
    ...
    public PtpName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public PtpName setIdCode(String idCode) {
    ...
    public PtpName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public PtpName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public PtpName setOrganizationName(String organizationName) {
