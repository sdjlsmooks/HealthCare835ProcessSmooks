...
public class PrescriptionDate implements Serializable, EDIWritable {
    ...
    public PrescriptionDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public PrescriptionDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public PrescriptionDate setDateTimePeriod(String dateTimePeriod) {
