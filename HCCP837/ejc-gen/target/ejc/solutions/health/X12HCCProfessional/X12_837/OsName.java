...
public class OsName implements Serializable, EDIWritable {
    ...
    public OsName setEntityIDCode(String entityIDCode) {
    ...
    public OsName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public OsName setLastName(String lastName) {
    ...
    public OsName setFirstName(String firstName) {
    ...
    public OsName setMiddleName(String middleName) {
    ...
    public OsName setNamePrefix(String namePrefix) {
    ...
    public OsName setNameSuffix(String nameSuffix) {
    ...
    public OsName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public OsName setIdCode(String idCode) {
    ...
    public OsName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public OsName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public OsName setOrganizationName(String organizationName) {
