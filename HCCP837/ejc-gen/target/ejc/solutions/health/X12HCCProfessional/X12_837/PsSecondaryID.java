...
public class PsSecondaryID implements Serializable, EDIWritable {
    ...
    public PsSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public PsSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public PsSecondaryID setDescription(String description) {
    ...
    public PsSecondaryID setReferenceIdentifier(String referenceIdentifier) {
