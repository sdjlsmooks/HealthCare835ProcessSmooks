...
public class RepricedClaimNumber implements Serializable, EDIWritable {
    ...
    public RepricedClaimNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public RepricedClaimNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public RepricedClaimNumber setDescription(String description) {
    ...
    public RepricedClaimNumber setReferenceIdentifier(String referenceIdentifier) {
