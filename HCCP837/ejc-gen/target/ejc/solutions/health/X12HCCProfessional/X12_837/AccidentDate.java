...
public class AccidentDate implements Serializable, EDIWritable {
    ...
    public AccidentDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public AccidentDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public AccidentDate setDateTimePeriod(String dateTimePeriod) {
