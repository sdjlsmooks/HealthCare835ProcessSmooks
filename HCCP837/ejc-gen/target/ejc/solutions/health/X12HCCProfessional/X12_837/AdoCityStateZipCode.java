...
public class AdoCityStateZipCode implements Serializable, EDIWritable {
    ...
    public AdoCityStateZipCode setCity(String city) {
    ...
    public AdoCityStateZipCode setState(String state) {
    ...
    public AdoCityStateZipCode setPostalCode(String postalCode) {
    ...
    public AdoCityStateZipCode setCountryCode(String countryCode) {
