...
public class SpSecondaryID implements Serializable, EDIWritable {
    ...
    public SpSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public SpSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public SpSecondaryID setDescription(String description) {
    ...
    public SpSecondaryID setReferenceIdentifier(String referenceIdentifier) {
