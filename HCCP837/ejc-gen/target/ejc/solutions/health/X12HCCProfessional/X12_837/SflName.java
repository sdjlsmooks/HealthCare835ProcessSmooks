...
public class SflName implements Serializable, EDIWritable {
    ...
    public SflName setEntityIDCode(String entityIDCode) {
    ...
    public SflName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public SflName setLastName(String lastName) {
    ...
    public SflName setFirstName(String firstName) {
    ...
    public SflName setMiddleName(String middleName) {
    ...
    public SflName setNamePrefix(String namePrefix) {
    ...
    public SflName setNameSuffix(String nameSuffix) {
    ...
    public SflName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public SflName setIdCode(String idCode) {
    ...
    public SflName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public SflName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public SflName setOrganizationName(String organizationName) {
