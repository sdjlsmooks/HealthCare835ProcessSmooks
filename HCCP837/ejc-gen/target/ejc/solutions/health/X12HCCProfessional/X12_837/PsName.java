...
public class PsName implements Serializable, EDIWritable {
    ...
    public PsName setEntityIDCode(String entityIDCode) {
    ...
    public PsName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public PsName setLastName(String lastName) {
    ...
    public PsName setFirstName(String firstName) {
    ...
    public PsName setMiddleName(String middleName) {
    ...
    public PsName setNamePrefix(String namePrefix) {
    ...
    public PsName setNameSuffix(String nameSuffix) {
    ...
    public PsName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public PsName setIdCode(String idCode) {
    ...
    public PsName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public PsName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public PsName setOrganizationName(String organizationName) {
