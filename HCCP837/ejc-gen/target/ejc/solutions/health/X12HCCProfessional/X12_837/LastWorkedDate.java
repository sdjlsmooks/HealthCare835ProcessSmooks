...
public class LastWorkedDate implements Serializable, EDIWritable {
    ...
    public LastWorkedDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public LastWorkedDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public LastWorkedDate setDateTimePeriod(String dateTimePeriod) {
