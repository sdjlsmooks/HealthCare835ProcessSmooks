...
public class AdjRepriceLIRefNumber implements Serializable, EDIWritable {
    ...
    public AdjRepriceLIRefNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public AdjRepriceLIRefNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public AdjRepriceLIRefNumber setDescription(String description) {
    ...
    public AdjRepriceLIRefNumber setReferenceIdentifier(String referenceIdentifier) {
