...
public class CarePlanOversight implements Serializable, EDIWritable {
    ...
    public CarePlanOversight setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public CarePlanOversight setReferenceIdentification(String referenceIdentification) {
    ...
    public CarePlanOversight setDescription(String description) {
    ...
    public CarePlanOversight setReferenceIdentifier(String referenceIdentifier) {
