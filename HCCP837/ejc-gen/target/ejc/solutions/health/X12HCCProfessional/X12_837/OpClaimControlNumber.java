...
public class OpClaimControlNumber implements Serializable, EDIWritable {
    ...
    public OpClaimControlNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpClaimControlNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public OpClaimControlNumber setDescription(String description) {
    ...
    public OpClaimControlNumber setReferenceIdentifier(String referenceIdentifier) {
