...
public class DischargeDate implements Serializable, EDIWritable {
    ...
    public DischargeDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public DischargeDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public DischargeDate setDateTimePeriod(String dateTimePeriod) {
