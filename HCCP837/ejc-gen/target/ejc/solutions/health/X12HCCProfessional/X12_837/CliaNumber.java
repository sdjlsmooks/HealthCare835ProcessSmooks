...
public class CliaNumber implements Serializable, EDIWritable {
    ...
    public CliaNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public CliaNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public CliaNumber setDescription(String description) {
    ...
    public CliaNumber setReferenceIdentifier(String referenceIdentifier) {
