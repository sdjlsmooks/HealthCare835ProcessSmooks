...
public class EpsdtReferral implements Serializable, EDIWritable {
    ...
    public EpsdtReferral setCodeCategory(String codeCategory) {
    ...
    public EpsdtReferral setYesNoCodeRespCode(String yesNoCodeRespCode) {
    ...
    public EpsdtReferral setCertificateCondCode1(String certificateCondCode1) {
    ...
    public EpsdtReferral setCertificateCondCode2(String certificateCondCode2) {
    ...
    public EpsdtReferral setCertificateCondCode3(String certificateCondCode3) {
    ...
    public EpsdtReferral setCertificateCondCode4(String certificateCondCode4) {
    ...
    public EpsdtReferral setCertificateCondCode5(String certificateCondCode5) {
