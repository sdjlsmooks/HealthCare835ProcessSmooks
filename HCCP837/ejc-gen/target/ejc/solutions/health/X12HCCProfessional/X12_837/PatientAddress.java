...
public class PatientAddress implements Serializable, EDIWritable {
    ...
    public PatientAddress setAddressInformation(String addressInformation) {
    ...
    public PatientAddress setAdditionalAddressInformation(String additionalAddressInformation) {
