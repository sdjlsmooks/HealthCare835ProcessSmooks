...
public class PresOrCompoundDrugNumber implements Serializable, EDIWritable {
    ...
    public PresOrCompoundDrugNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public PresOrCompoundDrugNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public PresOrCompoundDrugNumber setDescription(String description) {
    ...
    public PresOrCompoundDrugNumber setReferenceIdentifier(String referenceIdentifier) {
