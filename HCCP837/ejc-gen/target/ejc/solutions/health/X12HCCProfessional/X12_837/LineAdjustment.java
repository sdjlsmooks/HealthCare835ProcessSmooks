...
public class LineAdjustment implements Serializable, EDIWritable {
    ...
    public LineAdjustment setClaimAdjustmentGroupCode(String claimAdjustmentGroupCode) {
    ...
    public LineAdjustment setClaimAdjustmentReasonCode(String claimAdjustmentReasonCode) {
    ...
    public LineAdjustment setMonetaryAmount(String monetaryAmount) {
    ...
    public LineAdjustment setQuantity(Double quantity) {
    ...
    public LineAdjustment setClaimAdjustmentReasonCode2(String claimAdjustmentReasonCode2) {
    ...
    public LineAdjustment setMonetaryAmount2(String monetaryAmount2) {
    ...
    public LineAdjustment setQuantity2(Double quantity2) {
    ...
    public LineAdjustment setClaimAdjustmentReasonCode4(String claimAdjustmentReasonCode4) {
    ...
    public LineAdjustment setMonetaryAmount4(String monetaryAmount4) {
    ...
    public LineAdjustment setQuantity4(Double quantity4) {
    ...
    public LineAdjustment setClaimAdjustmentReasonCode5(String claimAdjustmentReasonCode5) {
    ...
    public LineAdjustment setMonetaryAmount5(String monetaryAmount5) {
    ...
    public LineAdjustment setQuantity5(Double quantity5) {
    ...
    public LineAdjustment setClaimAdjustmentReasonCode6(String claimAdjustmentReasonCode6) {
    ...
    public LineAdjustment setMonetaryAmount6(String monetaryAmount6) {
    ...
    public LineAdjustment setQuantity6(Double quantity6) {
    ...
    public LineAdjustment setClaimAdjustmentReasonCode7(String claimAdjustmentReasonCode7) {
    ...
    public LineAdjustment setMonetaryAmount7(String monetaryAmount7) {
    ...
    public LineAdjustment setQuantity7(Double quantity7) {
