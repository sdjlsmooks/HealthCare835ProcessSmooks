...
public class PriorAuth implements Serializable, EDIWritable {
    ...
    public PriorAuth setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public PriorAuth setReferenceIdentification(String referenceIdentification) {
    ...
    public PriorAuth setDescription(String description) {
    ...
    public PriorAuth setReferenceIdentifier(String referenceIdentifier) {
