...
public class LastCertificationDate implements Serializable, EDIWritable {
    ...
    public LastCertificationDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public LastCertificationDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public LastCertificationDate setDateTimePeriod(String dateTimePeriod) {
