...
public class AplName implements Serializable, EDIWritable {
    ...
    public AplName setEntityIDCode(String entityIDCode) {
    ...
    public AplName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public AplName setLastName(String lastName) {
    ...
    public AplName setFirstName(String firstName) {
    ...
    public AplName setMiddleName(String middleName) {
    ...
    public AplName setNamePrefix(String namePrefix) {
    ...
    public AplName setNameSuffix(String nameSuffix) {
    ...
    public AplName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public AplName setIdCode(String idCode) {
    ...
    public AplName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public AplName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public AplName setOrganizationName(String organizationName) {
