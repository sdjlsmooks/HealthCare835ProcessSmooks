...
public class ServFacilSecondID implements Serializable, EDIWritable {
    ...
    public ServFacilSecondID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public ServFacilSecondID setReferenceIdentification(String referenceIdentification) {
    ...
    public ServFacilSecondID setDescription(String description) {
    ...
    public ServFacilSecondID setReferenceIdentifier(String referenceIdentifier) {
