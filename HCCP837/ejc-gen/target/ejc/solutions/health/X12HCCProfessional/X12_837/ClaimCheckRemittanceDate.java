...
public class ClaimCheckRemittanceDate implements Serializable, EDIWritable {
    ...
    public ClaimCheckRemittanceDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public ClaimCheckRemittanceDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public ClaimCheckRemittanceDate setDateTimePeriod(String dateTimePeriod) {
