...
public class OpClaimAdjInd implements Serializable, EDIWritable {
    ...
    public OpClaimAdjInd setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpClaimAdjInd setReferenceIdentification(String referenceIdentification) {
    ...
    public OpClaimAdjInd setDescription(String description) {
    ...
    public OpClaimAdjInd setReferenceIdentifier(String referenceIdentifier) {
