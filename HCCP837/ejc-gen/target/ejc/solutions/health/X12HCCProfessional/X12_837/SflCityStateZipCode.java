...
public class SflCityStateZipCode implements Serializable, EDIWritable {
    ...
    public SflCityStateZipCode setCity(String city) {
    ...
    public SflCityStateZipCode setState(String state) {
    ...
    public SflCityStateZipCode setPostalCode(String postalCode) {
    ...
    public SflCityStateZipCode setCountryCode(String countryCode) {
