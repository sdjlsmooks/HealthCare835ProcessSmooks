...
public class DurMedCertNecessity implements Serializable, EDIWritable {
    ...
    public DurMedCertNecessity setRecordTypeCode(String recordTypeCode) {
    ...
    public DurMedCertNecessity setReportTransmitCode(String reportTransmitCode) {
    ...
    public DurMedCertNecessity setReportCopiesNeeded(Double reportCopiesNeeded) {
    ...
    public DurMedCertNecessity setEntityIDCode(String entityIDCode) {
    ...
    public DurMedCertNecessity setIdCodeQualifier(String idCodeQualifier) {
    ...
    public DurMedCertNecessity setIdCode(String idCode) {
    ...
    public DurMedCertNecessity setDescription(String description) {
    ...
    public DurMedCertNecessity setActionsIndicated(String actionsIndicated) {
    ...
    public DurMedCertNecessity setRequestCategoryCode(String requestCategoryCode) {
