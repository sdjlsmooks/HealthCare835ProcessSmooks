...
public class HomeboundIndicator implements Serializable, EDIWritable {
    ...
    public HomeboundIndicator setCodeCategory(String codeCategory) {
    ...
    public HomeboundIndicator setYesNoCodeRespCode(String yesNoCodeRespCode) {
    ...
    public HomeboundIndicator setCertificateCondCode1(String certificateCondCode1) {
    ...
    public HomeboundIndicator setCertificateCondCode2(String certificateCondCode2) {
    ...
    public HomeboundIndicator setCertificateCondCode3(String certificateCondCode3) {
    ...
    public HomeboundIndicator setCertificateCondCode4(String certificateCondCode4) {
    ...
    public HomeboundIndicator setCertificateCondCode5(String certificateCondCode5) {
