...
public class OprnSecondaryInformation implements Serializable, EDIWritable {
    ...
    public OprnSecondaryInformation setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OprnSecondaryInformation setReferenceIdentification(String referenceIdentification) {
    ...
    public OprnSecondaryInformation setDescription(String description) {
    ...
    public OprnSecondaryInformation setReferenceIdentifier(String referenceIdentifier) {
