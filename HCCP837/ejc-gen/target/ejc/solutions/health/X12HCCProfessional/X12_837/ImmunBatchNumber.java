...
public class ImmunBatchNumber implements Serializable, EDIWritable {
    ...
    public ImmunBatchNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public ImmunBatchNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public ImmunBatchNumber setDescription(String description) {
    ...
    public ImmunBatchNumber setReferenceIdentifier(String referenceIdentifier) {
