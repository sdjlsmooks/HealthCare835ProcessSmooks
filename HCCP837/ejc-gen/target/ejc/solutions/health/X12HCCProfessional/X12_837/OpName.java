...
public class OpName implements Serializable, EDIWritable {
    ...
    public OpName setEntityIDCode(String entityIDCode) {
    ...
    public OpName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public OpName setLastName(String lastName) {
    ...
    public OpName setFirstName(String firstName) {
    ...
    public OpName setMiddleName(String middleName) {
    ...
    public OpName setNamePrefix(String namePrefix) {
    ...
    public OpName setNameSuffix(String nameSuffix) {
    ...
    public OpName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public OpName setIdCode(String idCode) {
    ...
    public OpName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public OpName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public OpName setOrganizationName(String organizationName) {
