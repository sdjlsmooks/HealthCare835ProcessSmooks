...
public class CobPayerPaid implements Serializable, EDIWritable {
    ...
    public CobPayerPaid setAmountQualifierCode(String amountQualifierCode) {
    ...
    public CobPayerPaid setMonetaryAmount(String monetaryAmount) {
    ...
    public CobPayerPaid setCreditDebitFlagCode(String creditDebitFlagCode) {
