...
public class RpName implements Serializable, EDIWritable {
    ...
    public RpName setEntityIDCode(String entityIDCode) {
    ...
    public RpName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public RpName setLastName(String lastName) {
    ...
    public RpName setFirstName(String firstName) {
    ...
    public RpName setMiddleName(String middleName) {
    ...
    public RpName setNamePrefix(String namePrefix) {
    ...
    public RpName setNameSuffix(String nameSuffix) {
    ...
    public RpName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public RpName setIdCode(String idCode) {
    ...
    public RpName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public RpName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public RpName setOrganizationName(String organizationName) {
