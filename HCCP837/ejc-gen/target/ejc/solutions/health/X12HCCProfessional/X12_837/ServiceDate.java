...
public class ServiceDate implements Serializable, EDIWritable {
    ...
    public ServiceDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public ServiceDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public ServiceDate setDateTimePeriod(String dateTimePeriod) {
