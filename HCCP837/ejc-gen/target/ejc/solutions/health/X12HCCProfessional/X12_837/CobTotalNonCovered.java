...
public class CobTotalNonCovered implements Serializable, EDIWritable {
    ...
    public CobTotalNonCovered setAmountQualifierCode(String amountQualifierCode) {
    ...
    public CobTotalNonCovered setMonetaryAmount(String monetaryAmount) {
    ...
    public CobTotalNonCovered setCreditDebitFlagCode(String creditDebitFlagCode) {
