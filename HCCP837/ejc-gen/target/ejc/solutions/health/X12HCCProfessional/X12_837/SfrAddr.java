...
public class SfrAddr implements Serializable, EDIWritable {
    ...
    public SfrAddr setAddressInformation(String addressInformation) {
    ...
    public SfrAddr setAdditionalAddressInformation(String additionalAddressInformation) {
