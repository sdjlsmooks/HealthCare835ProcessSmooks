...
public class PtCityStateZipCode implements Serializable, EDIWritable {
    ...
    public PtCityStateZipCode setCity(String city) {
    ...
    public PtCityStateZipCode setState(String state) {
    ...
    public PtCityStateZipCode setPostalCode(String postalCode) {
    ...
    public PtCityStateZipCode setCountryCode(String countryCode) {
