...
public class PatientCityStateZipCode implements Serializable, EDIWritable {
    ...
    public PatientCityStateZipCode setCity(String city) {
    ...
    public PatientCityStateZipCode setState(String state) {
    ...
    public PatientCityStateZipCode setPostalCode(String postalCode) {
    ...
    public PatientCityStateZipCode setCountryCode(String countryCode) {
