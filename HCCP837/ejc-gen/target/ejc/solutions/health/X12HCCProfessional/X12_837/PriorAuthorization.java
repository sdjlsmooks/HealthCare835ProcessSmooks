...
public class PriorAuthorization implements Serializable, EDIWritable {
    ...
    public PriorAuthorization setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public PriorAuthorization setReferenceIdentification(String referenceIdentification) {
    ...
    public PriorAuthorization setDescription(String description) {
    ...
    public PriorAuthorization setReferenceIdentifier(String referenceIdentifier) {
