...
public class OpSecondaryID implements Serializable, EDIWritable {
    ...
    public OpSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public OpSecondaryID setDescription(String description) {
    ...
    public OpSecondaryID setReferenceIdentifier(String referenceIdentifier) {
