...
public class PtAddress implements Serializable, EDIWritable {
    ...
    public PtAddress setAddressInformation(String addressInformation) {
    ...
    public PtAddress setAdditionalAddressInformation(String additionalAddressInformation) {
