...
public class OpbpSecondaryID implements Serializable, EDIWritable {
    ...
    public OpbpSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpbpSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public OpbpSecondaryID setDescription(String description) {
    ...
    public OpbpSecondaryID setReferenceIdentifier(String referenceIdentifier) {
