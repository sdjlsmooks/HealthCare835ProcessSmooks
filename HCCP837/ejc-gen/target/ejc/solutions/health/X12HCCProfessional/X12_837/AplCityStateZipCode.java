...
public class AplCityStateZipCode implements Serializable, EDIWritable {
    ...
    public AplCityStateZipCode setCity(String city) {
    ...
    public AplCityStateZipCode setState(String state) {
    ...
    public AplCityStateZipCode setPostalCode(String postalCode) {
    ...
    public AplCityStateZipCode setCountryCode(String countryCode) {
