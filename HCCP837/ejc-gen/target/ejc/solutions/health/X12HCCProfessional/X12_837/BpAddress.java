...
public class BpAddress implements Serializable, EDIWritable {
    ...
    public BpAddress setAddressInformation(String addressInformation) {
    ...
    public BpAddress setAdditionalAddressInformation(String additionalAddressInformation) {
