...
public class OpPriorAuthNumber implements Serializable, EDIWritable {
    ...
    public OpPriorAuthNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpPriorAuthNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public OpPriorAuthNumber setDescription(String description) {
    ...
    public OpPriorAuthNumber setReferenceIdentifier(String referenceIdentifier) {
