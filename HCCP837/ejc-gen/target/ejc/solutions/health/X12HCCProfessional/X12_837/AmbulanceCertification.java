...
public class AmbulanceCertification implements Serializable, EDIWritable {
    ...
    public AmbulanceCertification setCodeCategory(String codeCategory) {
    ...
    public AmbulanceCertification setYesNoCodeRespCode(String yesNoCodeRespCode) {
    ...
    public AmbulanceCertification setCertificateCondCode1(String certificateCondCode1) {
    ...
    public AmbulanceCertification setCertificateCondCode2(String certificateCondCode2) {
    ...
    public AmbulanceCertification setCertificateCondCode3(String certificateCondCode3) {
    ...
    public AmbulanceCertification setCertificateCondCode4(String certificateCondCode4) {
    ...
    public AmbulanceCertification setCertificateCondCode5(String certificateCondCode5) {
