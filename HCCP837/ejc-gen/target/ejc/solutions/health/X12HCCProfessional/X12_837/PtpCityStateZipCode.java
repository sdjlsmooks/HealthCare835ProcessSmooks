...
public class PtpCityStateZipCode implements Serializable, EDIWritable {
    ...
    public PtpCityStateZipCode setCity(String city) {
    ...
    public PtpCityStateZipCode setState(String state) {
    ...
    public PtpCityStateZipCode setPostalCode(String postalCode) {
    ...
    public PtpCityStateZipCode setCountryCode(String countryCode) {
