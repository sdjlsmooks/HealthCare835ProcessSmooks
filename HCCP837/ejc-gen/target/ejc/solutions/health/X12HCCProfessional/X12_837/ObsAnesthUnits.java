...
public class ObsAnesthUnits implements Serializable, EDIWritable {
    ...
    public ObsAnesthUnits setQuantityQualifier(String quantityQualifier) {
    ...
    public ObsAnesthUnits setQuantity(Double quantity) {
