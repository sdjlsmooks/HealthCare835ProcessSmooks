...
public class ShipDate implements Serializable, EDIWritable {
    ...
    public ShipDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public ShipDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public ShipDate setDateTimePeriod(String dateTimePeriod) {
