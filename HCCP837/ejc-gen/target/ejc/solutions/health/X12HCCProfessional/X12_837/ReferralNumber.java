...
public class ReferralNumber implements Serializable, EDIWritable {
    ...
    public ReferralNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public ReferralNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public ReferralNumber setDescription(String description) {
    ...
    public ReferralNumber setReferenceIdentifier(String referenceIdentifier) {
