...
public class OpCityStateZipCode implements Serializable, EDIWritable {
    ...
    public OpCityStateZipCode setCity(String city) {
    ...
    public OpCityStateZipCode setState(String state) {
    ...
    public OpCityStateZipCode setPostalCode(String postalCode) {
    ...
    public OpCityStateZipCode setCountryCode(String countryCode) {
