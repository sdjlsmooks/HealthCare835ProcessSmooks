...
public class OpspSecondaryID implements Serializable, EDIWritable {
    ...
    public OpspSecondaryID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpspSecondaryID setReferenceIdentification(String referenceIdentification) {
    ...
    public OpspSecondaryID setDescription(String description) {
    ...
    public OpspSecondaryID setReferenceIdentifier(String referenceIdentifier) {
