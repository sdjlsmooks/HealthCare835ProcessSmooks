...
public class LastXRay implements Serializable, EDIWritable {
    ...
    public LastXRay setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public LastXRay setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public LastXRay setDateTimePeriod(String dateTimePeriod) {
