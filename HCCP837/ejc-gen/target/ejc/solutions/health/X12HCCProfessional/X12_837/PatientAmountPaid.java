...
public class PatientAmountPaid implements Serializable, EDIWritable {
    ...
    public PatientAmountPaid setAmountQualifierCode(String amountQualifierCode) {
    ...
    public PatientAmountPaid setMonetaryAmount(String monetaryAmount) {
    ...
    public PatientAmountPaid setCreditDebitFlagCode(String creditDebitFlagCode) {
