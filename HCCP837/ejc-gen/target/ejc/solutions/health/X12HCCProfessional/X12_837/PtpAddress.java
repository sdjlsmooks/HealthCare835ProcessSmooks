...
public class PtpAddress implements Serializable, EDIWritable {
    ...
    public PtpAddress setAddressInformation(String addressInformation) {
    ...
    public PtpAddress setAdditionalAddressInformation(String additionalAddressInformation) {
