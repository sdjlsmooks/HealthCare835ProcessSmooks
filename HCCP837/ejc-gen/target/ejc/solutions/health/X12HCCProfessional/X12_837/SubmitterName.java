...
public class SubmitterName implements Serializable, EDIWritable {
    ...
    public SubmitterName setEntityIDCode(String entityIDCode) {
    ...
    public SubmitterName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public SubmitterName setLastName(String lastName) {
    ...
    public SubmitterName setFirstName(String firstName) {
    ...
    public SubmitterName setMiddleName(String middleName) {
    ...
    public SubmitterName setNamePrefix(String namePrefix) {
    ...
    public SubmitterName setNameSuffix(String nameSuffix) {
    ...
    public SubmitterName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public SubmitterName setIdCode(String idCode) {
    ...
    public SubmitterName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public SubmitterName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public SubmitterName setOrganizationName(String organizationName) {
