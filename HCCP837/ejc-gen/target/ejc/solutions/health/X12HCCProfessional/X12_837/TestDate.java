...
public class TestDate implements Serializable, EDIWritable {
    ...
    public TestDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public TestDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public TestDate setDateTimePeriod(String dateTimePeriod) {
