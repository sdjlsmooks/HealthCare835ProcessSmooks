...
public class ClinicalLabNumber implements Serializable, EDIWritable {
    ...
    public ClinicalLabNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public ClinicalLabNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public ClinicalLabNumber setDescription(String description) {
    ...
    public ClinicalLabNumber setReferenceIdentifier(String referenceIdentifier) {
