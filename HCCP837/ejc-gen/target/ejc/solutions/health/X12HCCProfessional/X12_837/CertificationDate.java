...
public class CertificationDate implements Serializable, EDIWritable {
    ...
    public CertificationDate setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public CertificationDate setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public CertificationDate setDateTimePeriod(String dateTimePeriod) {
