...
public class AdlCityStateZipCode implements Serializable, EDIWritable {
    ...
    public AdlCityStateZipCode setCity(String city) {
    ...
    public AdlCityStateZipCode setState(String state) {
    ...
    public AdlCityStateZipCode setPostalCode(String postalCode) {
    ...
    public AdlCityStateZipCode setCountryCode(String countryCode) {
