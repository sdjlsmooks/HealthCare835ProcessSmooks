...
public class RpSpecialityInformation implements Serializable, EDIWritable {
    ...
    public RpSpecialityInformation setProviderCode(String providerCode) {
    ...
    public RpSpecialityInformation setReferenceIDQualifier(String referenceIDQualifier) {
    ...
    public RpSpecialityInformation setReferenceIdentification(String referenceIdentification) {
    ...
    public RpSpecialityInformation setStateOrProvinceCode(String stateOrProvinceCode) {
    ...
    public RpSpecialityInformation setProviderSpecalityInfo(String providerSpecalityInfo) {
    ...
    public RpSpecialityInformation setProviderOrgCode(String providerOrgCode) {
