...
public class OpAddress implements Serializable, EDIWritable {
    ...
    public OpAddress setAddressInformation(String addressInformation) {
    ...
    public OpAddress setAdditionalAddressInformation(String additionalAddressInformation) {
