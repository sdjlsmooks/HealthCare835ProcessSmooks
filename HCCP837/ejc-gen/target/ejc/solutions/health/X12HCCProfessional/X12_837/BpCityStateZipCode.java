...
public class BpCityStateZipCode implements Serializable, EDIWritable {
    ...
    public BpCityStateZipCode setCity(String city) {
    ...
    public BpCityStateZipCode setState(String state) {
    ...
    public BpCityStateZipCode setPostalCode(String postalCode) {
    ...
    public BpCityStateZipCode setCountryCode(String countryCode) {
