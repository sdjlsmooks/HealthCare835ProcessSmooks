...
public class OpReferralNumber implements Serializable, EDIWritable {
    ...
    public OpReferralNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public OpReferralNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public OpReferralNumber setDescription(String description) {
    ...
    public OpReferralNumber setReferenceIdentifier(String referenceIdentifier) {
