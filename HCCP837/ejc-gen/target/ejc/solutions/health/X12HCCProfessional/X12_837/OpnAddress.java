...
public class OpnAddress implements Serializable, EDIWritable {
    ...
    public OpnAddress setAddressInformation(String addressInformation) {
    ...
    public OpnAddress setAdditionalAddressInformation(String additionalAddressInformation) {
