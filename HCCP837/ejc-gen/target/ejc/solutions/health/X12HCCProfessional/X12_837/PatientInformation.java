...
public class PatientInformation implements Serializable, EDIWritable {
    ...
    private String benefitsCoordCord;
    ...
    public void write(Writer writer, Delimiters delimiters) throws IOException {
        ...
        nodeWriter.write(delimiters.getField());
        if(benefitsCoordCord != null) {
            nodeWriter.write(delimiters.escape(benefitsCoordCord.toString()));
            nodeTokens.add(nodeWriter.toString());
            ((StringWriter)nodeWriter).getBuffer().setLength(0);
        }
        nodeWriter.write(delimiters.getField());
    ...
    public PatientInformation setPayerRespSeqNoCode(String payerRespSeqNoCode) {
    ...
    public PatientInformation setIndividualRelatCode(String individualRelatCode) {
    ...
    public PatientInformation setReferenceIndentification(String referenceIndentification) {
    ...
    public PatientInformation setName(String name) {
    ...
    public PatientInformation setInsuranceTypeCode(String insuranceTypeCode) {
        this.insuranceTypeCode = insuranceTypeCode;  return this;
    }

    public String getBenefitsCoordCord() {
        return benefitsCoordCord;
    }

    public PatientInformation setBenefitsCoordCord(String benefitsCoordCord) {
        this.benefitsCoordCord = benefitsCoordCord;  return this;
    }
    ...
    public PatientInformation setYesNoCondRespCode(String yesNoCondRespCode) {
    ...
    public PatientInformation setEmploymentStatusCode(String employmentStatusCode) {
    ...
    public PatientInformation setClaimFileIndCode(String claimFileIndCode) {
