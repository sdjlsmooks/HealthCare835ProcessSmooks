...
public class BpName implements Serializable, EDIWritable {
    ...
    public BpName setEntityIDCode(String entityIDCode) {
    ...
    public BpName setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public BpName setLastName(String lastName) {
    ...
    public BpName setFirstName(String firstName) {
    ...
    public BpName setMiddleName(String middleName) {
    ...
    public BpName setNamePrefix(String namePrefix) {
    ...
    public BpName setNameSuffix(String nameSuffix) {
    ...
    public BpName setIdCodeQualifier(String idCodeQualifier) {
    ...
    public BpName setIdCode(String idCode) {
    ...
    public BpName setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public BpName setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public BpName setOrganizationName(String organizationName) {
