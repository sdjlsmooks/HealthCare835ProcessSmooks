...
public class OpsfReferringProvider implements Serializable, EDIWritable {
    ...
    public OpsfReferringProvider setEntityIDCode(String entityIDCode) {
    ...
    public OpsfReferringProvider setEntityTypeQualifier(String entityTypeQualifier) {
    ...
    public OpsfReferringProvider setLastName(String lastName) {
    ...
    public OpsfReferringProvider setFirstName(String firstName) {
    ...
    public OpsfReferringProvider setMiddleName(String middleName) {
    ...
    public OpsfReferringProvider setNamePrefix(String namePrefix) {
    ...
    public OpsfReferringProvider setNameSuffix(String nameSuffix) {
    ...
    public OpsfReferringProvider setIdCodeQualifier(String idCodeQualifier) {
    ...
    public OpsfReferringProvider setIdCode(String idCode) {
    ...
    public OpsfReferringProvider setEntityRelationshipCode(String entityRelationshipCode) {
    ...
    public OpsfReferringProvider setEntityIdentifierCode(String entityIdentifierCode) {
    ...
    public OpsfReferringProvider setOrganizationName(String organizationName) {
