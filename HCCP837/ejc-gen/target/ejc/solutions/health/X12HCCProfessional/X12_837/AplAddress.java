...
public class AplAddress implements Serializable, EDIWritable {
    ...
    public AplAddress setAddressInformation(String addressInformation) {
    ...
    public AplAddress setAdditionalAddressInformation(String additionalAddressInformation) {
