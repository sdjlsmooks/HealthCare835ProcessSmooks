...
public class DateOnsetCurrentIllness implements Serializable, EDIWritable {
    ...
    public DateOnsetCurrentIllness setDateTimeQualifier(String dateTimeQualifier) {
    ...
    public DateOnsetCurrentIllness setDateTimeFormatQualifier(String dateTimeFormatQualifier) {
    ...
    public DateOnsetCurrentIllness setDateTimePeriod(String dateTimePeriod) {
