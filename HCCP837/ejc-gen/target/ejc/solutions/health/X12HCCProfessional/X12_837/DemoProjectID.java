...
public class DemoProjectID implements Serializable, EDIWritable {
    ...
    public DemoProjectID setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public DemoProjectID setReferenceIdentification(String referenceIdentification) {
    ...
    public DemoProjectID setDescription(String description) {
    ...
    public DemoProjectID setReferenceIdentifier(String referenceIdentifier) {
