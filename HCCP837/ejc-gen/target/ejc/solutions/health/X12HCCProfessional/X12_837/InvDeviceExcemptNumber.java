...
public class InvDeviceExcemptNumber implements Serializable, EDIWritable {
    ...
    public InvDeviceExcemptNumber setReferenceIdentificationQualifier(String referenceIdentificationQualifier) {
    ...
    public InvDeviceExcemptNumber setReferenceIdentification(String referenceIdentification) {
    ...
    public InvDeviceExcemptNumber setDescription(String description) {
    ...
    public InvDeviceExcemptNumber setReferenceIdentifier(String referenceIdentifier) {
